...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        basebox/.style={rectangle, draw=black, line width=0.8pt, minimum height=0.85cm, align=center, font=\small\bfseries},
        primerbox/.style={basebox, fill=gray!15, text width=2.2cm},
        probebox/.style={basebox, fill=white, text width=2.0cm}
    ]
        ...
        \draw[decorate, decoration={brace, amplitude=5pt, mirror}, line width=0.8pt, color=black] 
            ($(p1.south west)+(0,-0.12)$) -- ($(p4.south east)+(0,-0.12)$)
        ...
        \draw[decorate, decoration={brace, amplitude=5pt}, line width=0.8pt, color=black] 
            ($(fwd.north west)+(0,0.12)$) -- ($(rev.north east)+(0,0.12)$)
            node[midway, above=6pt, font=\small\bfseries] {Linear dsDNA Construct (200 bp)};
    \end{tikzpicture}
