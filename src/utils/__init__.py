...
def resource_path(relative_path):
    ...
    try:
        ...
        # In dev, use the directory of this file as reference to get to root
        # Structure is root/src/utils/__init__.py
        # __file__ = .../src/utils/__init__.py
        # dirname = .../src/utils
        # dirname = .../src
        # dirname = .../ (root)
...
def run_uninstaller(parent_window=None):
    ...
    if getattr(sys, "frozen", False):
        ...
        # root/src/utils/__init__.py -> root/src/utils -> root/src -> root
